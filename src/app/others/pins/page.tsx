    ...
    const fetchStickersAndCrates = async () => {
        try {
            ...
            const filteredStickers: musickit[] = musickitsResponse.data.filter(
                (musickit: musickit) =>
                    !musickit.name.startsWith("StatTrak™") &&
                    musickit.market_hash_name !== null && // Filtra os musickits com market_hash_name null
                    musickit.type !== "Pass", // Filtra os musickits com type igual a "Pass"
            );
            ...
            console.error("Error fetching stickers and crates:", error); // Adicione um log de erro para facilitar a depuração
        }
    };
            ...
            <div className="bg-zinc-900">
                ...
                <div className="flex justify-center my-10 gap-10 items-center">
                    <div className="flex flex-col text-white font-medium px-6 gap-1">
                        <span className="text-4xl">All Pins</span>
                    </div>
                </div>
